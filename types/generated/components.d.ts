...
export interface BlogComponentTags extends Struct.ComponentSchema {
  collectionName: 'components_blog_component_tags';
  info: {
    displayName: 'Tags';
    icon: 'bulletList';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      'blog-component.tags': BlogComponentTags;
      'other.image': OtherImage;
